...
export const BottomSheetRenderItem: React.FC<BottomSheetRenderItemProps> = ({ getApproximativePrice, itemSelected, item, index, action }) => {

    const onPress = () => {
        const frais = action == 'reservation' ? item.frais_reservation : item.tarif_course_km;
        getApproximativePrice(index, frais)
    }

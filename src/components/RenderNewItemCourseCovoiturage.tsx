        ...
        <TouchableOpacity
            ...
            <View style={[ tw`flex-1 flex-row items-center justify-between ml-3` ]}>
                <View style={[ tw`flex-1` ]}>
                    <Text style={[ tw`text-black text-base font-medium`, {fontFamily:'Itim-Regular'} ]} numberOfLines={1} ellipsizeMode='tail'>{ item.conducteur.nom + ' ' + item.conducteur.prenom }</Text>
                    <View style={[ tw`` ]}>

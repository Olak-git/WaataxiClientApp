        ...
        <Base>
            ...
            >
                    ...
                    ?
                        <>
                            ...
                            <View style={tw`flex-1 pt-1 justify-between`}>
                                ...
                                <Text style={[tw`text-black`, {fontFamily:'Itim-Regular'}]} onPress={() => callPhoneNumber(conducteur.tel)}>{conducteur.tel}</Text>
                            </View>
                            <Rating
                                readonly
                ...
                <View style={tw`border-b border-gray-200 px-3 py-4`}>
                    ...
                    <View style={[ tw`flex-row justify-between px-2 mt-5` ]}>
                        <View style={[ tw`flex-row items-center bg-orange-100 rounded-2xl py-1 px-3` ]}>
                            ...
                            <Text style={[ tw`text-xs`, {color: ColorsEncr.main} ]}>{course.nb_km_parcouru ? course.nb_km_parcouru : course.nb_km_prov} km</Text>
                        </View>
                        {/* <View style={[ tw`flex-row items-center bg-orange-100 rounded-2xl py-1 px-3` ]}>
                            <Icon type='material-community' name='approximately-equal' size={20} iconStyle={{ color: ColorsEncr.main }} containerStyle={[ tw`mr-1` ]} />
                ...
                ?
                    <>
                        <View style={tw`items-center`}>
                            ...
                            <Text style={[tw`text-center text-gray-500 mb-3`, {fontFamily: 'YatraOne-Regular'}]}>Veuillez patienter! Un taxi plus proche de vous acceptera votre course et se rendra au point de départ au jour et heure indiquées.</Text>
                        </View>
                ...
                :
                    ...
                    ?
                        <View style={tw`items-center`}>
                            <Text style={[tw`text-center text-black text-xl`, {fontFamily: 'Itim-Regular'}]}>Réservation validée.</Text>
                            <Spinner isVisible={true} size={30} color={course.suis_la == 0 ? 'black' : 'green'} type='ThreeBounce' />
                            {course.suis_la == 0
                                ? <Text style={[tw`text-center text-gray-500 mb-3`, {fontFamily: 'YatraOne-Regular'}]}>Rendez-vous sur le point de départ au date et heure indiquées.</Text>
                                :  
                                <>
                                    <Text style={[tw`text-center text-gray-500`, {fontFamily: 'MontserratAlternates-SemiBold'}]}>Votre taxi est arrivé.</Text>
                                    <Text style={[tw`text-center text-gray-500 mb-3`, {fontFamily: 'YatraOne-Regular'}]}>Rendez-vous sur le point de départ.</Text>
                                </>
                            }
                        </View>
                    :
            ...
            {course.etat_course == 0 && (
                <View style={[ tw`justify-center px-4 border-t border-gray-300`, {height: 60} ]}>
                    ...
                    >
                        <Text style={[ tw`uppercase text-center font-medium text-black` ]}>Annuler</Text>
                    </TouchableOpacity>
                </View>
            )}
        </Base>
